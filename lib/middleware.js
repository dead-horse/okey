...
function Middleware() {
  ...
  this.dependencies = {
    ...
    etag: 'koa-etag',
    conditionalGet: 'koa-conditional-get',
    session: 'koa-sess',
  ...
  this.boots = {
    ...
    /**
     * check request if is fresh
     * work togather with etag
     */

    conditionalGet: function () {
      return require('koa-conditional-get')();
    },
    ...
    /**
     * csrf support by koa-csrf
     */

    csrf: function (app, opts) {
      return require('koa-csrf')(opts);
    },
  };
